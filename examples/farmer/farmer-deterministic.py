...
""""
This is a detereministic farmer problem example.
  (section 1.1a, pg. 4-5, Birge & Louveax)

A farmer is trying to decide what to plant for the next season.
    - He has wheat (1), corn (2), and sugar beets (3)
    - He can buy, sell, and produce any of these three products.
    - He must buy or produce a min. amoung of wheat / corn for his cattle.
    - Quota on sugar beets alters the price after a certain threshold.
Max. the net proficts from purchasing, selling, and planting crops for next season.
...
if __name__=="__main__":
    ...
    farmer.show_results("deterministic")