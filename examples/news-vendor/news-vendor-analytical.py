...
""""
This is an analytically derived optimal expression for solving the news vendor problem example.
...
Here we use the explicitly derived, analytical answer to this problem, as described/derived in the text.
